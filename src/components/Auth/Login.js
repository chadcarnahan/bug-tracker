  ...
  return (
    <div className="w-screen space-y-6 flex flex-col justify-center items-center">
      <div className="w-auto sm:w-96  flex-grow-1">
        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 space-y-6 content-center mt-20 text-gray-700 flex-grow-0">
          <div className="flex justify-center text-center">
            <h1 className="font-semibold">Please sign in to your account</h1>
          </div>
          <div>
            <h1 className="bg-red-100">{error}</h1>
          </div>
